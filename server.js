...
console.log('[DEBUG] SAFE_MODE está definido como:', SAFE_MODE);
// Static file serving for uploads - COMPLETELY SAFE VERSION
if (!SAFE_MODE) {
  ...
  // For Vercel - NO FILE SYSTEM OPERATIONS AT ALL
